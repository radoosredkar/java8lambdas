...
public class SampleData {
    ...
    public static final Album beatlesAlbum = new Album("The Beatles", asList(new Track("t1", 30)), membersOfTheBeatles );

    public static Stream<Album> albums = Stream.of(aLoveSupreme, sampleShortAlbum, manyTrackAlbum, beatlesAlbum);
